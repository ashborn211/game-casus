...
public class AttackColiderSword : MonoBehaviour
{
    ...
    // Add a reference to ModelMovement
    public CharacterMovement modelMovement; // Reference to the ModelMovement component
    ...
    void Start()
    {
        ...
        // Optionally, you can get the ModelMovement component if it's on the same GameObject
        // modelMovement = GetComponent<ModelMovement>();
    }
    ...
    void Update()
    {
        ...
        {
            characterMovement.PlayAttackAnimation();
